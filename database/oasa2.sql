...
--
-- Host: localhost
-- Generation Time: Dec 19, 2019 at 06:48 PM
...
-- Database: `oasa`
--
CREATE DATABASE IF NOT EXISTS `oasa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `oasa`;
...
('root', '[{\"db\":\"oasa\",\"table\":\"routes\"},{\"db\":\"oasa\",\"table\":\"users\"},{\"db\":\"oasa\",\"table\":\"itinerary\"}]');
...
('root', '2019-12-19 17:47:58', '{\"Console\\/Mode\":\"collapse\"}');
