                        ...
                        <div class="card-body">
                            <form action="login.php" method="POST">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <?php if($card==true) print '<input pattern=".{16}" type="tel" name="card" class="form-control is-invalid" value="'.(isset($_POST['card'])?$_POST['card']:'').'" placeholder="Αριθμός ATH.ENA Card" required title="Η ATH.ENA Card έχει 16 ψηφία" >' ?>
                                    <?php if($card==false) print '<input pattern=".{16}" type="tel" name="card" class="form-control '.(isset($_POST['card'])?'is-valid ':'').'" value="'.(isset($_POST['card'])?$_POST['card']:'').'" placeholder="Αριθμός ATH.ENA Card" required title="Η ATH.ENA Card έχει 16 ψηφία" >' ?>
